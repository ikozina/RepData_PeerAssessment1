...
```
Interval `r max_steps_interval` has maximum number of steps: `r max_steps`.
...
```
Total number of missing values: `r total_missing_values`
...
```{r average_steps_per_weektype_and_interval}
